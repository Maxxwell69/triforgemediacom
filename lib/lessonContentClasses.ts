 ...
 * wrapping <div style="color: ...">. Only `color` on the *container* is set
 * here, so anything the author didn't explicitly color still inherits
 * naturally — matching normal browser behavior.
 */
export const LESSON_CONTENT_CLASSES = [
  "font-body text-sm leading-relaxed text-charcoal/90",
