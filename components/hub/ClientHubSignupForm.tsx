...
import { completeClientHubSignup } from "@/app/hub-host/actions";
...
export default function ClientHubSignupForm({ token, email }: { token: string; email: string }) {
  const [state, formAction] = useFormState(completeClientHubSignup, null);
