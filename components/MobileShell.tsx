...
export default function MobileShell({
  ...
  return (
    ...
    >
      <div className="hub-nav sticky top-0 z-30 flex items-center justify-between border-b border-off-white/10 px-4 py-3 backdrop-blur md:hidden print:hidden">
      ...
      <div
        className={`${isChatRoom ? "hub-chat" : "hub-main"} flex min-w-0 flex-1 flex-col ${
